              ...
              우리.zip에 담다
                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            {isLoading === 'google' ? (
                                <div
                                    className="w-6 h-6 border-2 border-gray-300 border-t-primary-600 rounded-full animate-spin"/>
                            ) : (
                ...
                {isLoading === 'google' ? '로그인 중...' : 'Google로 시작하기'}
                        ...
                        >
                            {isLoading === 'kakao' ? (
                                <div
                                    className="w-6 h-6 border-2 border-yellow-600 border-t-yellow-800 rounded-full animate-spin"/>
                            ) : (
                ...
                {isLoading === 'kakao' ? '로그인 중...' : '카카오로 시작하기'}
                        ...
                        >
                            {isLoading === 'naver' ? (
                                <div
                                    className="w-6 h-6 border-2 border-green-300 border-t-white rounded-full animate-spin"/>
                            ) : (
