                  ...
                  {new Intl.NumberFormat('ko-KR', {style: 'currency', currency: 'KRW'}).format(remainingAmount)}
                                                                    ...
                                                                    <div className="flex space-x-2">
                                                                        ...
                                                                        {currentGroup.members.filter(m => m.userId !== user?.id).map(member => (
                                                                            <button
                                                                                ...
                                                                                className="px-2 py-1 bg-orange-100 text-[#df6d14] rounded text-xs hover:bg-orange-200 transition-colors"
                                                                            >
                                                ...
                                                return (
                                                    <label key={member.userId} className="flex items-center space-x-3">
                                                        ...
                                                        {formData.splitData[member.userId] !== undefined && (
                                                            <span className="text-sm text-[#df6d14] ml-auto">
                                ...
                                {formData.splitType === 'EQUAL' && (
                                    <div className="bg-orange-50 rounded-lg p-4">
                                        <h4 className="text-sm font-medium text-[#df6d14] mb-2">균등 분할</h4>
                                        <p className="text-sm text-[#df6d14]">
                        ...
                        <div className="flex space-x-3 pt-4">
                            ...
                            {!expense?.isGroupShare && (
                                <motion.button
                                    type="submit"
                                    className={`px-4 py-2 bg-[#df6d14] text-white rounded-lg font-medium transition-colors ${
                                        isSubmitting ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#c55a0f]'
                                    }`}
