                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-2xl font-bold text-right"
                                placeholder="10,000"
                                inputMode="numeric"
                            />
                        </div>
                                                ...
                                                return (
                                                    <label key={member.userId} className="flex items-center space-x-3">
                                                        <input
                                                            ...
                                                            className="rounded border-gray-300 accent-primary-500 focus:ring-primary-500"
                                                        />
                                                        <span
